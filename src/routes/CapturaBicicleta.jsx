...
function ValidacaoCameraBicicleta() {
  ...
  return (
    <div className="pagina-validacao-camera">
      <h1>Validação da Câmera - Captura da Bicicleta</h1>
      <p>
        Posicione a câmera de forma que a bicicleta seja visível. Em seguida, capture a imagem.
      </p>
...
export default ValidacaoCameraBicicleta;
