...
function ValidacaoCameraPneuDianteiro() {
  ...
  return (
    <div className="pagina-validacao-camera">
      <h1>Validação da Câmera - Captura do Pneu Dianteiro</h1>
      <p>
        Posicione a câmera de forma que o pneu dianteiro da bicicleta seja visível. Em seguida, capture a imagem.
      </p>
...
export default ValidacaoCameraPneuDianteiro;
